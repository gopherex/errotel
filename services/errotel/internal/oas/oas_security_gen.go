...
var operationRolesBearerAuth = map[string][]string{
	...
	GetFacetsOperation:         []string{},
	GetHistogramOperation:      []string{},
	GetOccurrenceOperation:     []string{},
	GetRelatedLogsOperation:    []string{},
	GetTraceOperation:          []string{},
	InvestigateOperation:       []string{},
	PrepareAlertOperation:      []string{},
	SearchOccurrencesOperation: []string{},
}
