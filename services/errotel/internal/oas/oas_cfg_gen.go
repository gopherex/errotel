...
var regexMap = map[string]ogenregex.Regexp{
	"^(0|[1-9][0-9]*)$": ogenregex.MustCompile("^(0|[1-9][0-9]*)$"),
	"^[0-9a-f]{16}$":    ogenregex.MustCompile("^[0-9a-f]{16}$"),
	"^[0-9a-f]{32}$":    ogenregex.MustCompile("^[0-9a-f]{32}$"),
	"^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$": ogenregex.MustCompile("^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$"),
	"^[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?$":                                  ogenregex.MustCompile("^[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?$"),
	"^[a-zA-Z0-9_-]{1,64}$":                                                 ogenregex.MustCompile("^[a-zA-Z0-9_-]{1,64}$"),
	"^[a-zA-Z_][a-zA-Z0-9_]{0,63}$":                                         ogenregex.MustCompile("^[a-zA-Z_][a-zA-Z0-9_]{0,63}$"),
}
